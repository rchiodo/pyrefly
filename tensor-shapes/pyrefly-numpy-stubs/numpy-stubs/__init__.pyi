...
class ndarray[Shape: _Shape = _AnyShape, DType = Any]:
    ...
    dtype: DType
    @overload
    def __len__[N](self: ndarray[SizeTuple[N]]) -> Dim[N]: ...
    @overload
    def __len__[N, M](self: ndarray[SizeTuple[N, M]]) -> Dim[N]: ...
    def __getitem__[
        N,
        M,
        I,
        ...
        self: ndarray[SizeTuple[N, M], DType],
        key: tuple[
            ndarray[SizeTuple[I], dtype[RowIndexScalar]],
            ndarray[SizeTuple[I], dtype[ColumnIndexScalar]],
        ],
    ) -> ndarray[SizeTuple[I], DType]: ...
    # Only 2-D transpose is modeled for the NumPy shape-stub MVP.
    @property
    def T[N, P](
        self: ndarray[SizeTuple[N, P], DType],
    ) -> ndarray[SizeTuple[P, N], DType]: ...
    @overload
    ...
    def __matmul__[N, M, P](
        self: ndarray[SizeTuple[N, M], DType],
        other: ndarray[SizeTuple[M, P]],
    ) -> ndarray[SizeTuple[N, P], DType]: ...
    ...
    ) -> ndarray[SizeTuple[M], DType]: ...
    @overload
    def mean[N](
        self: ndarray[SizeTuple[N], DType],
    ) -> ndarray[tuple[()], DType]: ...
    @overload
    def sum[N, M](
        self: ndarray[SizeTuple[N, M], DType],
    ...
    ) -> ndarray[SizeTuple[N, 1], DType]: ...
    @overload
    def sum[N, M, K](
        self: ndarray[SizeTuple[N, M, K], DType],
        axis: Literal[1],
        *,
        keepdims: Literal[False] = False,
...
def arange[N](stop: Dim[N], /) -> ndarray[SizeTuple[N], dtype[intp]]: ...
@overload
def expand_dims[N, M, DType](
    a: ndarray[SizeTuple[N, M], DType],
    axis: Literal[0, -3],
) -> ndarray[SizeTuple[1, N, M], DType]: ...
@overload
def expand_dims[N, M, DType](
    a: ndarray[SizeTuple[N, M], DType],
    axis: Literal[1, -2],
) -> ndarray[SizeTuple[N, 1, M], DType]: ...
@overload
def expand_dims[N, M, DType](
    a: ndarray[SizeTuple[N, M], DType],
    axis: Literal[2, -1],
...
@overload
def argmin[N, M](
    a: ndarray[SizeTuple[N, M]],
    axis: Literal[0, -2],
    *,
    keepdims: Literal[False] = False,
) -> ndarray[SizeTuple[M], dtype[intp]]: ...
@overload
def argmin[N, M](
    a: ndarray[SizeTuple[N, M]],
    axis: Literal[1, -1],
    *,
    keepdims: Literal[False] = False,
) -> ndarray[SizeTuple[N], dtype[intp]]: ...
...
) -> ndarray[SizeTuple[N], dtype[ScalarT]]: ...
@overload
def zeros[N, ScalarT: generic](
...
) -> ndarray[SizeTuple[N, M], dtype[ScalarT]]: ...
@overload
def zeros[N, ScalarT: generic](
...
) -> ndarray[SizeTuple[N], dtype[float64]]: ...
@overload
def zeros[N](
...
@overload
def zeros[N](shape: Dim[N], dtype: Any, order: str = ...) -> ndarray[SizeTuple[N]]: ...
@overload
def zeros[N](
...
@overload
def ones[N](shape: Dim[N], dtype: Any, order: str = ...) -> ndarray[SizeTuple[N]]: ...
@overload
def ones[N](
    shape: tuple[Dim[N]], dtype: Any, order: str = ...
) -> ndarray[SizeTuple[N]]: ...
...
@overload
def empty[N](shape: Dim[N], dtype: Any, order: str = ...) -> ndarray[SizeTuple[N]]: ...
@overload
def empty[N](
    shape: tuple[Dim[N]], dtype: Any, order: str = ...
) -> ndarray[SizeTuple[N]]: ...
...
) -> ndarray[SizeTuple[N, N], dtype[ScalarT]]: ...
@overload
def eye[N, ScalarT: generic](
    N: Dim[N], M: None, k: int, dtype: type[ScalarT], order: str = ...
) -> ndarray[SizeTuple[N, N], dtype[ScalarT]]: ...
...
) -> ndarray[SizeTuple[N, N], dtype[float64]]: ...
@overload
def eye[N](
    N: Dim[N], M: None = ..., k: int = ..., dtype: Any = ..., order: str = ...
) -> ndarray[SizeTuple[N, N]]: ...
@overload
