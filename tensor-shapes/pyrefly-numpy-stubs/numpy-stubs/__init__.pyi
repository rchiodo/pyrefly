...
def expand_dims[N, M, DType](
    ...
    axis: Literal[0, -3],
) -> ndarray[tuple[Dim[1], Dim[N], Dim[M]], DType]: ...
@overload
def expand_dims[N, M, DType](
    a: ndarray[tuple[Dim[N], Dim[M]], DType],
    axis: Literal[1, -2],
) -> ndarray[tuple[Dim[N], Dim[1], Dim[M]], DType]: ...
@overload
def expand_dims[N, M, DType](
    a: ndarray[tuple[Dim[N], Dim[M]], DType],
    axis: Literal[2, -1],
...
@overload
def argmin[N, M](
    a: ndarray[tuple[Dim[N], Dim[M]]],
    axis: Literal[0, -2],
    *,
    keepdims: Literal[False] = False,
) -> ndarray[tuple[Dim[M]], dtype[intp]]: ...
@overload
def argmin[N, M](
    a: ndarray[tuple[Dim[N], Dim[M]]],
    axis: Literal[1, -1],
    *,
    keepdims: Literal[False] = False,
) -> ndarray[tuple[Dim[N]], dtype[intp]]: ...
