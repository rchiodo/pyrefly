...
@overload
def catch(exception: T) -> T: ...  # E: Implementation signature `(f: S | None = None, *, exception: T) -> T | S` does not accept all arguments that overload signature `(exception: T) -> T` accepts
