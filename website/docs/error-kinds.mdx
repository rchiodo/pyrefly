...
The default severity of this diagnostic is `ignore`. Enable it with [`pytorch-efficiency-lints = true`](./configuration.mdx#pytorch-efficiency-lints) in your `pyrefly.toml`.
