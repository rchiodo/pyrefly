...
- Enables (as errors): [`implicit-any`](./error-kinds.mdx#implicit-any), [`unannotated-parameter`](./error-kinds.mdx#unannotated-parameter), [`unannotated-attribute`](./error-kinds.mdx#unannotated-attribute), [`missing-override-decorator`](./error-kinds.mdx#missing-override-decorator), [`unused-ignore`](./error-kinds.mdx#unused-ignore)
